...
function angleBetweenClockHands(date) {
  ...
  let rez = 0.5 * (60 * maxDate.getUTCHours() + maxDate.getUTCMinutes())
   - 6 * maxDate.getUTCMinutes();
  if (rez > 540) rez = 540 - rez;
  if (rez > 180) rez = 360 - rez;
  return (Math.abs(rez) * Math.PI) / 180;
}
